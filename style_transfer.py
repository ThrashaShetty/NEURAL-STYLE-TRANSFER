...
# === FILE PATHS ===
base_dir = r"C:\Codehut\Codetech\style_transfer_project"
content_path = os.path.join(base_dir, "C:\Codehut\Codetech\style_transfer_project\content.jpg")
style_path = os.path.join(base_dir,"C:\Codehut\Codetech\style_transfer_project\style.jpg")
